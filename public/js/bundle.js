...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"resendCode.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.resendCode = void 0;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              ...
              if (phone) {
                emailObj = JSON.parse(localStorage.getItem('email'));
...
var _resendCode = require("./resendCode");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (_context.t0.response.data.message.startsWith('Your account is not yet verified!')) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'There is an error! Try again.');
...
var handleNotVerifiedError = function handleNotVerifiedError() {
  var value = document.getElementById('emailOrPhone').value;
  var resendEl = document.getElementById('resend');
  if (resendEl) resendEl.parentElement.removeChild(resendEl);
  var el = document.getElementById('container');
  var markup = "<button data-value=".concat(value, " id='resend'>Resend code?</button>");
  el.insertAdjacentHTML('afterbegin', markup);
  var resend = document.getElementById('resend');
  resend.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var regEx, re;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 6;
            return (0, _resendCode.resendCode)({
              phone: value
            });
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","./resendCode":"resendCode.js"}],"signup.js":[function(require,module,exports) {
"use strict";
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, email) {
    var res, phoneObj;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'We sent you a code! Please check your email.');
              phoneObj = JSON.parse(localStorage.getItem('phone'));
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"signupPhone.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.signupPhone = void 0;
...
var signupPhone = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, phone) {
    var res, emailObj;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'We sent you a code! Please check your Phone.');
              emailObj = JSON.parse(localStorage.getItem('email'));
              if (emailObj) localStorage.removeItem('email');
              localStorage.setItem('phone', JSON.stringify({
                phone: phone
  ...
  return function signupPhone(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.signupPhone = signupPhone;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"verifyTwilio.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.verifyTwilio = void 0;
...
var verifyTwilio = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(phone, code) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
  ...
  return function verifyTwilio(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.verifyTwilio = verifyTwilio;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"verify.js":[function(require,module,exports) {
"use strict";
...
var verify = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(code, type) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success' && res.data.message) {
              (0, _alerts.showAlert)('success', res.data.message);
              window.setTimeout(function () {
                location.assign("/resetPassword/".concat(code));
              }, 2000);
            }
...
var forgotPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var res, email, phone, phoneObj, emailObj;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2LWFobWVka2hhbGlsIiwiYSI6ImNrYTZmZWJiMjA2ZTQycXA5cDVxcHFsM3IifQ.uwMFnTcynnISs3QJ6vTf5A';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extend the map bound to include current location
...
var stripe = Stripe('pk_test_yN1o5VqK83jMTSLIH9SWQuOD008MsQdbUO');
...
var resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(token, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var _signupPhone = require("./signupPhone");

var _verifyTwilio = require("./verifyTwilio");
...
var signupEmailForm = document.querySelector('.form__email--signup');
var signupPhoneForm = document.querySelector('.form__phone--signup');
var logoutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour');
var btnSocial = document.querySelectorAll('.btn__form--social');
var verifyContinueForm = document.querySelector('.form__verify--continue');
var forgotPasswordForm = document.querySelector('.form__forgotPassword--continue');
var resetPasswordForm = document.querySelector('.form__resetPassword--continue');
var resend = document.getElementById('resendCode');

if (resend) {
  resend.addEventListener('click', /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var phoneObj, emailObj, query, resetPassword, phone, email, _phone, _email;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 8;
            return (0, _forgotPassword.forgotPassword)({
              phone: phone
            });
...
if (signupPhoneForm) {
  signupPhoneForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var el, countryCode, name, phone, password, passwordConfirm, photo, form, err;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              countryCode = el.options[el.selectedIndex].value;
              ...
              _context2.next = 18;
              return (0, _signupPhone.signupPhone)(form, phone);
...
if (verifyContinueForm) {
  verifyContinueForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var code, query, resetPassword, phoneObj, emailObj, phone;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 7;
              return (0, _verify.verify)(code, 'resetPassword');
            ...
            case 8:
              phoneObj = JSON.parse(localStorage.getItem('phone'));
              emailObj = JSON.parse(localStorage.getItem('email')); // This mean the user delete the localStorage!

              if (!(!phoneObj && !emailObj)) {
                _context3.next = 12;
                break;
              }

              return _context3.abrupt("return", (0, _alerts.showAlert)('error', 'Something went wrong!'));
            ...
            case 12:
              ...
              phone = phoneObj.phone;
              _context3.next = 16;
              return (0, _verifyTwilio.verifyTwilio)(phone, code);
            ...
            case 17:
              _context3.next = 19;
              return (0, _verify.verify)(code, 'normal');
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              return _context4.abrupt("return", (0, _alerts.showAlert)('error', 'Please enter a valid email address or mobile number'));
      ...
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              e.preventDefault();
              token = document.getElementById('hasToken').dataset.token;
              password = document.getElementById('password').value;
              passwordConfirm = document.getElementById('passwordConfirm').value;
              _context5.next = 6;
              return (0, _resetPassword.resetPassword)(token, password, passwordConfirm);
...
if (loginForm) {
  loginForm.addEventListener('submit', function (e) {
    ...
    if (!regEx.test(emailOrPhone.toLowerCase()) && !re.test(emailOrPhone.toLowerCase())) {
      return (0, _alerts.showAlert)('error', 'Please enter a valid email address or mobile number');
    }
...
if (signupEmailForm) {
  signupEmailForm.addEventListener('submit', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              _context6.next = 11;
              return (0, _signup.signup)(form, email);
